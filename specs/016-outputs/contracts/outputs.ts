 ...
 * load/build API, OUT_* diagnostic codes and result shapes. Mirrors contract
 * versioning rules -- codes live here, consumers compare against the OUT_*
 * constants (Constitution V), the YAML format carries `version: 1`.
 */

import type { TerraformResource } from '../../src/contracts/terraform.js';
import type { GeneratedTfFile } from '../../src/contracts/materialize.js';
 ...
 * contract violation; section 26, Constitution V).
 */
