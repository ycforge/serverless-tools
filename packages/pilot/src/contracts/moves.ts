 ...
 *
 * Type-only + pure constants: zero runtime imports (the static-consistency
 * test `T103` compares this catalog against `contracts/moves.json`
 * #/errorCodes).
 */

import type { ProjectModelDiagnostic } from './project-model.js';
import type { TerraformMoved } from './terraform.js';
