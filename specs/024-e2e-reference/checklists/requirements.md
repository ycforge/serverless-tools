...
- Analytical divergence resolved per instructions: roadmap row 024 fixed to the canonical app set (`orders` → `analytics`), status ⬜ → 🚧, dependencies → 001–023, in this same commit.
