...
| 16 | B не проверяет guard-семантику | FR-010 | — (не правило, а запрет) | — |
| 17 | B не провижинит auth-инфраструктуру | FR-011 | — (не правило, а запрет) | — |

Запреты 16–17 — НЕ ошибки валидации, а границы области B (Constitution I); фиксируются в контракте, а не в check-логике.
